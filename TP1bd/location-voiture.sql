...
CREATE TABLE IF NOT EXISTS `clients` (
  ...
  `nom_prénom` varchar(30) NOT NULL,
...
INSERT INTO `clients` (`ncin`, `num_permis`, `nom_prénom`, `adresse`, `tel`, `date_naissance`, `email`) VALUES
(12, 1000, 'Rémy', 'Paris', '06', 2000, 0),
(13, 2000, 'David', 'Creteil', '07-12', 2002, 0);
...
INSERT INTO `voitures` (`immatriculation`, `marque`, `modèle`, `carburant`, `kilometrage`, `date_circulation`, `couleur`) VALUES
